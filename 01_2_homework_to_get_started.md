...
If you don't already have a GitHub account, sign up for one. Email me your GitHub username so I can add you to the class organization. This is where you will submit assignments. If you were in my class in the past, no need to send this as I have it already, unless you want to change the account you use.
...
1. Go to the class GitHub organization: https://github.com/EBIO5460Fall2026.
2. Find your repo. It should be visible on the `Repositories` tab. Your repo is called `pm4e_firstname-lastinitial`.
...
5. Type `git clone` and paste the URL you just copied. It will look something like this (e.g. if it were mine):
   ```bash
   git clone https://github.com/EBIO5460Fall2026/pm4e-brett-m.git
   ```
